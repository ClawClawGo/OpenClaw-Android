...
```
openclaw-mobile/
├── App.tsx                          # Root: navigation, bootstrap, budget alerts
├── app.json                         # Expo config
├── docs/
│   └── relay-protocol.md            # WebSocket JSON-RPC 2.0 protocol spec
└── src/
    ├── theme/
    ...
    └── screens/
        ├── OnboardingScreen.tsx     # Auth: relay URL + token entry
...
1. Enter your **Cloud Relay URL** (e.g. `wss://relay.openclaw.io`)
2. Enter your **Auth Token** (generated from your OpenClaw Gateway)
3. Tap **Connect Securely** — your token is saved to Keychain/Keystore
4. You're in! The Dashboard will show your gateway status and recent activity
